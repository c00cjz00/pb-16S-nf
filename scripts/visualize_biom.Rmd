...
if(params$merged_tax_tab_file != ""){
  ...
  cat(paste0("* ASVs classified at Species level (Excluding metagenome/uncultured entries): ", nrow(class_spec_uncultured), " (", round(nrow(class_spec_uncultured)/total_asv, 4)*100, "%)  \n"))
  cat(paste0("* Percentage reads belong to ASV classified at Species level (Excluding metagenome/uncultured entries): ", round(sum(otu_table(physeq_list[["besttax"]])[class_spec_uncultured$OTU,])/sum(otu_table(physeq_list[["besttax"]])), 2)*100, "%  \n"))
  cat(paste0("* ASVs classified at Genus level: ", nrow(class_gen), " (", round(nrow(class_gen)/total_asv, 4)*100, "%)  \n"))
  cat(paste0("* ASVs classified at Genus level (Excluding metagenome/uncultured entries): ", nrow(class_gen_uncultured), " (", round(nrow(class_gen_uncultured)/total_asv, 4)*100, "%)  \n"))
  cat(paste0("* Percentage reads belong to ASV classified at Genus level (Excluding metagenome/uncultured entries): ", round(sum(otu_table(physeq_list[["besttax"]])[class_gen_uncultured$OTU,])/sum(otu_table(physeq_list[["besttax"]])), 2)*100, "%  \n"))
}
```
